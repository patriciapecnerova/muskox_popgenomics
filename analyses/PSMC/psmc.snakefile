...
open($fh, "| tee $prefix.gp | /binf-isilon/hansgrp/ppecnerova/softscratch/gnuplot-5.4.0/bin/gnuplot") || die;
print $fh qq(
  set size 1, 0.8;
...
if (defined $opts{p}) {
  system("/binf-isilon/hansgrp/ppecnerova/softscratch/epstopdf/epstopdf.pl $prefix.eps");
}
